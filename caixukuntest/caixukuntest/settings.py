...
# Scrapy settings for caixukuntest project
#
...
BOT_NAME = 'caixukuntest'

SPIDER_MODULES = ['caixukuntest.spiders']
NEWSPIDER_MODULE = 'caixukuntest.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'caixukuntest (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'caixukuntest.middlewares.CaixukuntestSpiderMiddleware': 543,
#}
...
DOWNLOADER_MIDDLEWARES = {
   'caixukuntest.middlewares.TooManyRequestsRetryMiddleware': 543,
}
...
ITEM_PIPELINES = {
    'caixukuntest.pipelines.CaixukuntestPipeline': 300,
}
